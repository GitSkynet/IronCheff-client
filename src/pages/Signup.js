  ...
  render() {
    ...
    return (
      <div className="container-login">
        <div className="img">
        <img src="https://res.cloudinary.com/ytyt/image/upload/v1611683147/undraw_Fingerprint_re_uf3f_otleqr.svg" alt="Profile"/>
        </div>
        <div className="login-content">
          <form action="index.html" onSubmit={this.handleFormSubmit}>
            <img src="https://raw.githubusercontent.com/sefyudem/Responsive-Login-Form/82b8d8efd3b0ac6382b9d0d71a99c6cf9dcefa23/img/avatar.svg" alt="Profile"/>
              ...
              <Button type="submit" className=".btn-login" value="SIGN UP">Sign up</Button>
            </form>
            </div>
          </div>
    );
